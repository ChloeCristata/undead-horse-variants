...
execute at @n[type=zombie_horse,team=!husk_horse,scores={sponge_counter=1}] run particle minecraft:small_gust ~ ~ ~ 0.5 1 0.5 1 5
...
execute at @n[type=zombie_horse,team=!husk_horse,scores={sponge_counter=2}] run particle minecraft:small_gust ~ ~ ~ 0.5 1 0.5 1 10
...
execute at @n[type=zombie_horse,team=!husk_horse,scores={sponge_counter=3}] run particle minecraft:small_gust ~ ~ ~ 0.5 1 0.5 1 20
